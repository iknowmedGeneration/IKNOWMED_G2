...
public class SeeTestDriverFactory {
	 ...
	 */
	public static MobileWebDriver getSeeTestDriver(String host, int port,
			...
			String iOSAppName, String androidWebAppName, String iosWebAppName,
			String deviceName) {
		...
		try {
			...
			case WEB_ANDROID:
				driver.setDevice(androidPrefix);
				driver.application("chrome:" + androidWebAppName).launch(false,
						true);
				break;
			case WEB_IOS:
				// yet to implement
				driver.setDevice(iosPrefix);
				driver.application("safari:" + iosWebAppName)
						.launch(true, true);
				break;
			default:
				break;
