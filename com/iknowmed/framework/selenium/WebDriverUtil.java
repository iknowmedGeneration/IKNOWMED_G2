...
public class WebDriverUtil {
	...
	public Boolean isAlertPresent(long timeOutInSeconds) {
		 ...
		 * @param length The Length of the random number. Max length 14
		 * @return Boolean value indicating whether an alert is present
		 */
		public String createRandomNumber(Integer length){
			DateFormat dateFormat = new SimpleDateFormat("yyyyMMddHHmmss");
			Date dDate = new Date();
			String actualVal = dateFormat.format(dDate).toString();
			String randomnumber = actualVal.substring(14-length, 14);
			return randomnumber;
