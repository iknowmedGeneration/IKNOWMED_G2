...
interface ReportType {
	 ...
	 *            The filename of the screenshot file (in case of failed step)
	 * @param perfObject
	 *            This is required for pass PerfInsight Object
	 */
	public void updateTestLog(String stepNumber, String stepName,
			String stepDescription, Status stepStatus, String screenshotName,
	 ...
	 *            The current step number
	 * @param utterances
	 *            The utterances for Alexa Skill
	 * @param expectedValue
	 *            The expected Value for Alexa utterances
	 * @param actualValue
	 *            The actual Value for Alexa utterances
	 * @param stepStatus
	 *            The {@link Status} of the test step
	 */
